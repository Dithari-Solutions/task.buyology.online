  ...
  return (
    <div className="space-y-3.5">
      ...
      <div className="flex items-center gap-2 pt-1">
        ...
        <button
          onClick={onDelete}
          className="ml-auto rounded-lg p-1.5 text-ink-400 transition-colors hover:bg-rose-50 hover:text-rose-600"
...
export function EdgeInspector({
  ...
  return (
    <div className="space-y-3.5">
      <Field label="Label">
        <Input value={label} placeholder="reads exam results" onChange={(event) => setLabel(event.target.value)} />
      </Field>
      <Field label="Technology">
